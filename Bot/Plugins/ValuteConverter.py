...
class ValuteConverter(BasePlug):
    ...
    def work(self, peer_id, msg: str, event: vk_api.bot_longpoll.VkBotEvent) -> None:
        ...
        try:
            ...
            self.__send_message(peer_id, "Ты должен ввести цифру!\nНапример: /конвертер 5 usd")
        if val <= 0:
            self.__send_message(peer_id, "Число должно быть больше 0!")
        elif text[2] == "usd":
            ...
            self.__send_message(peer_id, "Выбери: usd или eur!\nНапример: /конвертер 5 usd")
