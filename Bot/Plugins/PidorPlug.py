    ...
    def work(self, peer_id: int, msg: str, event: bot_longpoll.VkBotEvent):
        ...
        try:
            ...
            if str(chosen["member_id"]).startswith("-"):
                ...
                last_name = ""
                self.bot.send_message(peer_id, f'Пидор - [{user["screen_name"]}|{first_name} {last_name}]')
            else:
                ...
                self.bot.send_message(peer_id, f'Кто - {who}? Я думаю это [id{user["id"]}|{first_name} {last_name}]')
